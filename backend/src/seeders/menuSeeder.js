...
const menuData = [
  ...
  {
    meal_type: 'lunch', name: 'Aloo Matar', cuisine_type: 'North Indian',
    sub_category: 'Sabzi',
  ...
  {
    meal_type: 'lunch', name: 'Lauki Sabzi', cuisine_type: 'North Indian',
    sub_category: 'Sabzi',
  ...
  {
    meal_type: 'lunch', name: 'Paneer Bhurji', cuisine_type: 'North Indian',
    sub_category: 'Sabzi',
  ...
  {
    meal_type: 'lunch', name: 'Methi Thepla with Dahi', cuisine_type: 'Gujarati',
    sub_category: 'Sabzi',
  ...
  {
    meal_type: 'lunch', name: 'Dahi Aloo', cuisine_type: 'North Indian',
    sub_category: 'Sabzi',
  ...
  // ─── Paneer Sabzi ───
  {
    ...
    kitchen_equipment: 'kadai,blender,tawa', difficulty: 'medium',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
      { name: 'Paneer', quantity: '250', unit: 'g', calories: 400 },
  ...
  },
  {
    ...
    kitchen_equipment: 'kadai,tawa', difficulty: 'medium',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
      { name: 'Paneer', quantity: '250', unit: 'g', calories: 400 },
  ...
  },
  {
    ...
    kitchen_equipment: 'grill/tawa,kadai', difficulty: 'medium',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
      { name: 'Paneer', quantity: '250', unit: 'g', calories: 400 },
  ...
  {
    meal_type: 'lunch', name: 'Paneer Saag', cuisine_type: 'Punjabi',
    sub_category: 'Paneer Sabzi',
  ...
  {
    meal_type: 'lunch', name: 'Paneer Kofta Curry', cuisine_type: 'North Indian',
    sub_category: 'Paneer Sabzi',
    ...
    kitchen_equipment: 'kadai,deep pan,tawa', difficulty: 'hard',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
      { name: 'Paneer', quantity: '250', unit: 'g', calories: 400 },
  ...
  },
  {
    ...
    kitchen_equipment: 'kadai,deep pan', difficulty: 'medium',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
  ...
  {
    meal_type: 'lunch', name: 'Aloo Gobhi (Dry)', cuisine_type: 'North Indian',
    sub_category: 'Gobhi Sabzi',
  ...
  // ─── Kadhi ───
  {
    ...
    calories_per_serving: 470, protein_g: 14, carbs_g: 58, fat_g: 24, fiber_g: 5,
    kitchen_equipment: 'kadai,deep pan,pressure cooker', difficulty: 'medium',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
  ...
  },
  {
    ...
    prep_time_minutes: 10, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 350, protein_g: 10, carbs_g: 52, fat_g: 16, fiber_g: 3,
  ...
  },
  {
    ...
    prep_time_minutes: 15, cook_time_minutes: 30, servings: 4,
    calories_per_serving: 390, protein_g: 10, carbs_g: 60, fat_g: 16, fiber_g: 8,
  ...
  {
    meal_type: 'lunch', name: 'Gujarati Kadhi', cuisine_type: 'Gujarati',
    sub_category: 'Kadhi',
    description: 'Sweet-tangy thin Gujarati kadhi with mustard-curry leaf tempering',
    prep_time_minutes: 5, cook_time_minutes: 15, servings: 4,
    calories_per_serving: 310, protein_g: 9, carbs_g: 50, fat_g: 13, fiber_g: 2,
    kitchen_equipment: 'kadai,pressure cooker', difficulty: 'easy',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
      { name: 'Dahi (curd)', quantity: '1', unit: 'cup', calories: 150 },
  ...
  },
  {
    ...
    kitchen_equipment: 'bowl,grater', difficulty: 'easy',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
      { name: 'Dahi (curd)', quantity: '1.5', unit: 'cups', calories: 220 },
  ...
  },
  {
    ...
    kitchen_equipment: 'bowl,saucepan', difficulty: 'easy',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
      { name: 'Dahi (curd)', quantity: '1.5', unit: 'cups', calories: 220 },
  ...
  },
  {
    ...
    kitchen_equipment: 'kadai,oven optional', difficulty: 'medium',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
  ...
  },
  {
    ...
    kitchen_equipment: 'pressure cooker,kadai,tawa', difficulty: 'easy',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
  ...
  // ─── Dal ───
  {
    meal_type: 'lunch', name: 'Dal Tadka', cuisine_type: 'North Indian',
    sub_category: 'Dal',
    description: 'Yellow toor dal with a smoky ghee-tempered tadka, served with steamed rice',
    prep_time_minutes: 10, cook_time_minutes: 30, servings: 4,
    calories_per_serving: 395, protein_g: 16, carbs_g: 72, fat_g: 14, fiber_g: 7,
  ...
  {
    meal_type: 'lunch', name: 'Rajma', cuisine_type: 'North Indian',
    sub_category: 'Dal',
    ...
    calories_per_serving: 415, protein_g: 18, carbs_g: 78, fat_g: 12, fiber_g: 12,
    kitchen_equipment: 'pressure cooker,kadai', difficulty: 'easy',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
  ...
  {
    meal_type: 'lunch', name: 'Masoor Dal', cuisine_type: 'North Indian',
    sub_category: 'Dal',
    description: 'Red lentil dal tempered with onion-tomato tadka, served with steamed rice',
    prep_time_minutes: 5, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 365, protein_g: 16, carbs_g: 70, fat_g: 11, fiber_g: 8,
    kitchen_equipment: 'pressure cooker,kadai', difficulty: 'easy',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
  ...
  {
    meal_type: 'lunch', name: 'Moong Dal Tadka', cuisine_type: 'Indian',
    sub_category: 'Dal',
    description: 'Light yellow moong dal with a simple ghee-cumin-garlic tadka, served with rice',
    prep_time_minutes: 5, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 345, protein_g: 15, carbs_g: 68, fat_g: 10, fiber_g: 7,
    kitchen_equipment: 'pressure cooker,kadai', difficulty: 'easy',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
  ...
  {
    meal_type: 'lunch', name: 'Panchmel Dal', cuisine_type: 'Rajasthani',
    sub_category: 'Dal',
    description: 'Five lentils cooked together with spices — Rajasthani dal dhokli style',
    prep_time_minutes: 10, cook_time_minutes: 30, servings: 4,
    calories_per_serving: 395, protein_g: 18, carbs_g: 72, fat_g: 12, fiber_g: 10,
    kitchen_equipment: 'pressure cooker,kadai', difficulty: 'easy',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
  ...
  {
    meal_type: 'lunch', name: 'Lauki Dal', cuisine_type: 'North Indian',
    sub_category: 'Dal',
  ...
  {
    meal_type: 'lunch', name: 'Palak Dal', cuisine_type: 'North Indian',
    sub_category: 'Dal',
  ...
  {
    meal_type: 'lunch', name: 'Chana Masala', cuisine_type: 'North Indian',
    sub_category: 'Dal',
  ...
  // ─── Khichdi ───
  {
    meal_type: 'lunch', name: 'Dal Khichdi', cuisine_type: 'Indian',
    sub_category: 'Khichdi',
  ...
  {
    meal_type: 'lunch', name: 'Sabudana Khichdi', cuisine_type: 'Indian',
    sub_category: 'Khichdi',
  ...
  {
    meal_type: 'lunch', name: 'Moong Dal Khichdi', cuisine_type: 'Indian',
    sub_category: 'Khichdi',
  ...
  {
    meal_type: 'lunch', name: 'Veg Khichdi', cuisine_type: 'Indian',
    sub_category: 'Khichdi',
    description: 'One-pot rice, moong dal and mixed veg khichdi with ghee — complete comforting meal',
    prep_time_minutes: 10, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 370, protein_g: 13, carbs_g: 58, fat_g: 10, fiber_g: 6,
    kitchen_equipment: 'pressure cooker,kadai', difficulty: 'easy',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
      { name: 'Rice', quantity: '0.75', unit: 'cup', calories: 255 },
  ...
  // ─── Rice/Chawal ───
  {
    meal_type: 'lunch', name: 'Jeera Rice', cuisine_type: 'Indian',
    sub_category: 'Rice/Chawal',
    description: 'Fragrant cumin-tempered basmati rice — pairs perfectly with any dal or sabzi',
    prep_time_minutes: 5, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 410, protein_g: 13, carbs_g: 72, fat_g: 12, fiber_g: 4,
    kitchen_equipment: 'kadai,pressure cooker', difficulty: 'easy',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
  ...
  {
    meal_type: 'lunch', name: 'Coconut Rice', cuisine_type: 'South Indian',
    sub_category: 'Rice/Chawal',
    description: 'Fragrant coconut-tempered rice served with toor dal sambar and papad',
    prep_time_minutes: 10, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 430, protein_g: 10, carbs_g: 70, fat_g: 14, fiber_g: 4,
    kitchen_equipment: 'kadai,pressure cooker', difficulty: 'easy',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
  ...
  {
    meal_type: 'lunch', name: 'Veg Pulao', cuisine_type: 'Indian',
    sub_category: 'Rice/Chawal',
    description: 'Mildly spiced vegetable pulao served with refreshing boondi raita',
    prep_time_minutes: 10, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 440, protein_g: 11, carbs_g: 70, fat_g: 14, fiber_g: 5,
  ...
  {
    meal_type: 'lunch', name: 'Steamed Basmati Rice', cuisine_type: 'Indian',
    sub_category: 'Rice/Chawal',
    description: 'Perfectly cooked fluffy basmati rice — essential with any dal or sabzi',
    prep_time_minutes: 5, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 200, protein_g: 4, carbs_g: 42, fat_g: 1, fiber_g: 0,
    kitchen_equipment: 'pressure cooker', difficulty: 'easy',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
      { name: 'Basmati rice', quantity: '1.5', unit: 'cups', calories: 510 },
    ]
  ...
  {
    meal_type: 'lunch', name: 'Matar Pulao', cuisine_type: 'North Indian',
    sub_category: 'Rice/Chawal',
    description: 'Fragrant basmati rice with green peas and cumin — quick wholesome rice dish',
    prep_time_minutes: 5, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 340, protein_g: 9, carbs_g: 58, fat_g: 8, fiber_g: 4,
    kitchen_equipment: 'pressure cooker,kadai', difficulty: 'easy',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
      { name: 'Basmati rice', quantity: '1.5', unit: 'cups', calories: 510 },
      { name: 'Green peas', quantity: '0.75', unit: 'cup', calories: 90 },
      { name: 'Oil', quantity: '1.5', unit: 'tbsp', calories: 180 },
      { name: 'Cumin seeds, whole spices', quantity: '1', unit: 'tsp', calories: 5 },
    ]
  },
  {
    meal_type: 'lunch', name: 'Kashmiri Pulao', cuisine_type: 'Kashmiri',
    sub_category: 'Rice/Chawal',
    description: 'Saffron rice with dry fruits, nuts and rose petals — a royal festive rice',
    prep_time_minutes: 10, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 420, protein_g: 8, carbs_g: 62, fat_g: 14, fiber_g: 2,
    kitchen_equipment: 'pressure cooker,kadai', difficulty: 'medium',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
      { name: 'Basmati rice', quantity: '1.5', unit: 'cups', calories: 510 },
      { name: 'Mixed dry fruits (cashews, almonds, raisins)', quantity: '4', unit: 'tbsp', calories: 200 },
      { name: 'Ghee', quantity: '2', unit: 'tbsp', calories: 180 },
      { name: 'Saffron', quantity: '1', unit: 'pinch', calories: 2 },
    ]
  },
  {
    meal_type: 'lunch', name: 'Methi Rice', cuisine_type: 'Indian',
    sub_category: 'Rice/Chawal',
    description: 'Rice cooked with fresh fenugreek leaves and mild spices — aromatic and nutritious',
    prep_time_minutes: 5, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 330, protein_g: 7, carbs_g: 54, fat_g: 9, fiber_g: 3,
    kitchen_equipment: 'pressure cooker,kadai', difficulty: 'easy',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
      { name: 'Basmati rice', quantity: '1.5', unit: 'cups', calories: 510 },
      { name: 'Fresh methi leaves', quantity: '1', unit: 'cup', calories: 30 },
      { name: 'Oil', quantity: '1.5', unit: 'tbsp', calories: 180 },
      { name: 'Cumin, turmeric', quantity: '0.5', unit: 'tsp each', calories: 4 },
    ]
  },
  {
    meal_type: 'lunch', name: 'Tamarind Rice', cuisine_type: 'South Indian',
    sub_category: 'Rice/Chawal',
    description: 'Tangy South Indian tamarind rice with peanuts and curry leaf tempering — Puliyodarai',
    prep_time_minutes: 10, cook_time_minutes: 15, servings: 4,
    calories_per_serving: 390, protein_g: 7, carbs_g: 62, fat_g: 13, fiber_g: 3,
    kitchen_equipment: 'kadai,bowl', difficulty: 'easy',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
      { name: 'Rice (cooked)', quantity: '1.5', unit: 'cups', calories: 340 },
      { name: 'Tamarind paste', quantity: '2', unit: 'tbsp', calories: 30 },
      { name: 'Peanuts', quantity: '2', unit: 'tbsp', calories: 100 },
      { name: 'Oil', quantity: '2', unit: 'tbsp', calories: 240 },
      { name: 'Mustard seeds, curry leaves, chana dal', quantity: '1', unit: 'tsp', calories: 8 },
    ]
  },
  {
    meal_type: 'lunch', name: 'Ghee Rice', cuisine_type: 'Kerala',
    sub_category: 'Rice/Chawal',
    description: 'Fragrant Kerala-style ghee rice with cashews and fried onion — rich and festive',
    prep_time_minutes: 5, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 370, protein_g: 6, carbs_g: 52, fat_g: 14, fiber_g: 1,
    kitchen_equipment: 'pressure cooker,kadai', difficulty: 'easy',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
      { name: 'Basmati rice', quantity: '1.5', unit: 'cups', calories: 510 },
      { name: 'Ghee', quantity: '2.5', unit: 'tbsp', calories: 225 },
      { name: 'Cashews', quantity: '10', unit: 'pcs', calories: 100 },
      { name: 'Fried onion', quantity: '0.25', unit: 'cup', calories: 100 },
    ]
  },
  // ─── Biryani ───
  {
  ...
  {
    meal_type: 'lunch', name: 'Paneer Biryani', cuisine_type: 'Mughal',
    sub_category: 'Biryani',
    description: 'Aromatic basmati rice layered with marinated paneer, saffron and fried onions',
    prep_time_minutes: 25, cook_time_minutes: 40, servings: 4,
    calories_per_serving: 560, protein_g: 18, carbs_g: 72, fat_g: 20, fiber_g: 5,
    kitchen_equipment: 'heavy pot,tawa', difficulty: 'medium',
    is_vegetarian: true, is_vegan: false,
    ingredients: [
      { name: 'Basmati rice', quantity: '1.5', unit: 'cups', calories: 510 },
      ...
      { name: 'Fried onion (birista)', quantity: '0.5', unit: 'cup', calories: 200 },
      { name: 'Ghee', quantity: '3', unit: 'tbsp', calories: 270 },
      { name: 'Saffron, whole spices, mint', quantity: '1', unit: 'tsp', calories: 8 },
    ]
  },
  {
    meal_type: 'lunch', name: 'Mushroom Biryani', cuisine_type: 'Hyderabadi',
    sub_category: 'Biryani',
    description: 'Earthy mushrooms dum-cooked with fragrant basmati rice and whole spices',
    prep_time_minutes: 20, cook_time_minutes: 40, servings: 4,
    calories_per_serving: 490, protein_g: 12, carbs_g: 72, fat_g: 15, fiber_g: 5,
    kitchen_equipment: 'heavy pot,tawa', difficulty: 'medium',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
      { name: 'Basmati rice', quantity: '1.5', unit: 'cups', calories: 510 },
      { name: 'Button mushrooms', quantity: '300', unit: 'g', calories: 75 },
      { name: 'Oil', quantity: '3', unit: 'tbsp', calories: 360 },
      { name: 'Fried onion, whole spices, mint', quantity: '0.5', unit: 'cup', calories: 200 },
    ]
  },
  {
    meal_type: 'lunch', name: 'Matar Biryani', cuisine_type: 'Indian',
    sub_category: 'Biryani',
    description: 'Fragrant basmati rice with green peas, mint and aromatic whole spices',
    prep_time_minutes: 15, cook_time_minutes: 35, servings: 4,
    calories_per_serving: 450, protein_g: 11, carbs_g: 74, fat_g: 12, fiber_g: 6,
    kitchen_equipment: 'heavy pot', difficulty: 'medium',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
      { name: 'Basmati rice', quantity: '1.5', unit: 'cups', calories: 510 },
      { name: 'Green peas', quantity: '1', unit: 'cup', calories: 120 },
      { name: 'Oil', quantity: '2.5', unit: 'tbsp', calories: 300 },
      { name: 'Whole spices, mint', quantity: '1', unit: 'tsp', calories: 8 },
    ]
  },
  {
    meal_type: 'lunch', name: 'Kathal Biryani', cuisine_type: 'Awadhi',
    sub_category: 'Biryani',
    description: 'Raw jackfruit slow-cooked with aromatic biryani spices — meaty and indulgent',
    prep_time_minutes: 25, cook_time_minutes: 45, servings: 4,
    calories_per_serving: 480, protein_g: 10, carbs_g: 76, fat_g: 13, fiber_g: 8,
    kitchen_equipment: 'heavy pot,pressure cooker', difficulty: 'medium',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
      { name: 'Basmati rice', quantity: '1.5', unit: 'cups', calories: 510 },
      { name: 'Raw jackfruit (kathal)', quantity: '400', unit: 'g', calories: 200 },
      { name: 'Oil', quantity: '3', unit: 'tbsp', calories: 360 },
      { name: 'Fried onion, whole spices', quantity: '0.5', unit: 'cup', calories: 180 },
    ]
  },
  {
    meal_type: 'lunch', name: 'Tawa Biryani', cuisine_type: 'Mumbai Street',
    sub_category: 'Biryani',
    description: 'Street-style biryani tossed on a large tawa with vegetables and biryani masala',
    prep_time_minutes: 10, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 440, protein_g: 10, carbs_g: 68, fat_g: 14, fiber_g: 5,
    kitchen_equipment: 'large tawa,spatula', difficulty: 'medium',
    is_vegetarian: true, is_vegan: true,
    ingredients: [
      { name: 'Cooked basmati rice', quantity: '2', unit: 'cups', calories: 450 },
      { name: 'Mixed vegetables', quantity: '1.5', unit: 'cups', calories: 120 },
      { name: 'Oil', quantity: '2.5', unit: 'tbsp', calories: 300 },
      { name: 'Biryani masala, capsicum, onion', quantity: '1', unit: 'serving', calories: 60 },
    ]
  },
  // ─── Chana Chole ───
  {
  ...
  {
    meal_type: 'dinner', name: 'Aloo Gobhi', cuisine_type: 'North Indian',
    sub_category: 'Sabzi',
    description: 'Dry spiced potato and cauliflower stir fry — a classic North Indian sabzi',
    prep_time_minutes: 10, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 390, protein_g: 11, carbs_g: 68, fat_g: 14, fiber_g: 8,
  ...
  {
    meal_type: 'dinner', name: 'Palak Paneer', cuisine_type: 'North Indian',
    sub_category: 'Sabzi',
    description: 'Creamy spinach curry with soft paneer cubes',
    prep_time_minutes: 15, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 450, protein_g: 20, carbs_g: 52, fat_g: 24, fiber_g: 6,
  ...
  {
    meal_type: 'dinner', name: 'Paneer Butter Masala', cuisine_type: 'North Indian',
    sub_category: 'Sabzi',
    description: 'Paneer in rich tomato-butter gravy with aromatic spices,',
    prep_time_minutes: 15, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 520, protein_g: 22, carbs_g: 56, fat_g: 28, fiber_g: 4,
  ...
  {
    meal_type: 'dinner', name: 'Bhindi Masala', cuisine_type: 'North Indian',
    sub_category: 'Sabzi',
    description: 'Stir-fried okra with onion, tomato and spices',
    prep_time_minutes: 10, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 350, protein_g: 9, carbs_g: 58, fat_g: 15, fiber_g: 9,
  ...
  {
    meal_type: 'dinner', name: 'Baingan Bharta', cuisine_type: 'Punjabi',
    sub_category: 'Sabzi',
    description: 'Smoky roasted eggplant mash with onion, tomato and spices, ',
    prep_time_minutes: 10, cook_time_minutes: 30, servings: 4,
    calories_per_serving: 320, protein_g: 8, carbs_g: 58, fat_g: 11, fiber_g: 9,
  ...
  {
    meal_type: 'dinner', name: 'Paneer Do Pyaza', cuisine_type: 'North Indian',
    sub_category: 'Paneer Sabzi',
    description: 'Paneer cooked with double the onion in two stages — sweet and spicy',
    prep_time_minutes: 10, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 410, protein_g: 18, carbs_g: 34, fat_g: 28, fiber_g: 4,
  ...
  {
    meal_type: 'dinner', name: 'Paneer Tikka Masala', cuisine_type: 'Punjabi',
    sub_category: 'Paneer Sabzi',
    description: 'Grilled marinated paneer chunks simmered in smoky tomato-based masala gravy',
    prep_time_minutes: 20, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 470, protein_g: 22, carbs_g: 32, fat_g: 34, fiber_g: 4,
  ...
  {
    meal_type: 'dinner', name: 'Paneer Lababdar', cuisine_type: 'Punjabi',
    sub_category: 'Paneer Sabzi',
    description: 'Soft paneer in a thick, indulgent onion-tomato-cashew gravy',
    prep_time_minutes: 15, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 450, protein_g: 20, carbs_g: 30, fat_g: 35, fiber_g: 3,
  ...
  {
    meal_type: 'dinner', name: 'Gobhi Matar', cuisine_type: 'North Indian',
    sub_category: 'Gobhi Sabzi',
  ...
  {
    meal_type: 'dinner', name: 'Achari Gobhi', cuisine_type: 'North Indian',
    sub_category: 'Gobhi Sabzi',
    description: 'Tangy cauliflower cooked with pickling spices — bold and appetising',
    prep_time_minutes: 10, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 300, protein_g: 8, carbs_g: 48, fat_g: 15, fiber_g: 7,
  ...
  {
    meal_type: 'dinner', name: 'Gobhi Manchurian (Dry)', cuisine_type: 'Indo-Chinese',
    sub_category: 'Gobhi Sabzi',
    description: 'Crispy fried cauliflower tossed in a tangy Indo-Chinese sauce',
    prep_time_minutes: 15, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 420, protein_g: 10, carbs_g: 58, fat_g: 17, fiber_g: 5,
  ...
  {
    meal_type: 'dinner', name: 'Dum Aloo Gobhi', cuisine_type: 'North Indian',
    sub_category: 'Gobhi Sabzi',
    description: 'Potato and cauliflower slow-cooked dum-style in rich spiced gravy',
    prep_time_minutes: 10, cook_time_minutes: 30, servings: 4,
    calories_per_serving: 370, protein_g: 9, carbs_g: 62, fat_g: 16, fiber_g: 7,
  ...
  {
    meal_type: 'dinner', name: 'Aloo Methi', cuisine_type: 'North Indian',
    sub_category: 'Aloo Sabzi',
    description: 'Potatoes stir-fried with fresh fenugreek leaves — slightly bitter, very flavourful',
    prep_time_minutes: 10, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 310, protein_g: 8, carbs_g: 56, fat_g: 12, fiber_g: 7,
  ...
  {
    meal_type: 'dinner', name: 'Aloo Tamatar', cuisine_type: 'North Indian',
    sub_category: 'Aloo Sabzi',
    description: 'Simple potato and tomato sabzi with spices — everyday North Indian staple',
    prep_time_minutes: 5, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 300, protein_g: 7, carbs_g: 56, fat_g: 12, fiber_g: 5,
  ...
  {
    meal_type: 'dinner', name: 'Aloo Baingan', cuisine_type: 'North Indian',
    sub_category: 'Aloo Sabzi',
    description: 'Potato and brinjal cooked together in a spiced dry masala',
    prep_time_minutes: 10, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 310, protein_g: 7, carbs_g: 54, fat_g: 14, fiber_g: 7,
  ...
  {
    meal_type: 'dinner', name: 'Sindhi Kadhi', cuisine_type: 'Sindhi',
    sub_category: 'Kadhi',
    description: 'Besan-based Sindhi kadhi packed with mixed vegetables — no yogurt used',
    prep_time_minutes: 15, cook_time_minutes: 30, servings: 4,
    calories_per_serving: 390, protein_g: 10, carbs_g: 60, fat_g: 16, fiber_g: 8,
  ...
  {
    meal_type: 'dinner', name: 'Cucumber Raita', cuisine_type: 'Indian',
    sub_category: 'Raita',
    description: 'Cooling grated cucumber in seasoned yogurt — refreshing with any heavy meal',
    prep_time_minutes: 5, cook_time_minutes: 0, servings: 4,
    calories_per_serving: 120, protein_g: 6, carbs_g: 12, fat_g: 5, fiber_g: 1,
  ...
  {
    meal_type: 'dinner', name: 'Onion Tomato Raita', cuisine_type: 'Indian',
    sub_category: 'Raita',
    description: 'Chunky onion and tomato mixed into spiced yogurt — great with biryani and pulao',
    prep_time_minutes: 5, cook_time_minutes: 0, servings: 4,
    calories_per_serving: 130, protein_g: 6, carbs_g: 14, fat_g: 5, fiber_g: 2,
  ...
  {
    meal_type: 'dinner', name: 'Bharwa Karela', cuisine_type: 'North Indian',
    sub_category: 'Stuffed Sabzi',
    description: 'Bitter gourd stuffed with spiced onion-amchur filling — an acquired taste',
    prep_time_minutes: 20, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 260, protein_g: 7, carbs_g: 38, fat_g: 16, fiber_g: 6,
  ...
  {
    meal_type: 'dinner', name: 'Bharwa Tamatar', cuisine_type: 'North Indian',
    sub_category: 'Stuffed Sabzi',
    description: 'Whole tomatoes stuffed with spiced paneer-potato filling and cooked in their own juices',
    prep_time_minutes: 15, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 330, protein_g: 13, carbs_g: 44, fat_g: 18, fiber_g: 4,
  ...
  {
    meal_type: 'dinner', name: 'Arbi Masala', cuisine_type: 'North Indian',
    sub_category: 'Other Sabzi',
    description: 'Crispy taro root cooked in tangy amchur-spiced masala',
    prep_time_minutes: 15, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 360, protein_g: 7, carbs_g: 64, fat_g: 15, fiber_g: 6,
  ...
  {
    meal_type: 'dinner', name: 'Lobhia Masala', cuisine_type: 'North Indian',
    sub_category: 'Other Sabzi',
    description: 'Black-eyed peas in a tangy tomato-onion gravy — wholesome and earthy',
    prep_time_minutes: 10, cook_time_minutes: 30, servings: 4,
    calories_per_serving: 390, protein_g: 17, carbs_g: 66, fat_g: 13, fiber_g: 14,
  ...
  {
    meal_type: 'dinner', name: 'Kathal Ki Sabzi', cuisine_type: 'North Indian',
    sub_category: 'Other Sabzi',
    description: 'Raw jackfruit cooked in spiced onion-tomato gravy — meaty texture, full of flavour',
    prep_time_minutes: 20, cook_time_minutes: 30, servings: 4,
    calories_per_serving: 350, protein_g: 8, carbs_g: 62, fat_g: 14, fiber_g: 9,
  ...
  {
    meal_type: 'dinner', name: 'Rajma', cuisine_type: 'North Indian',
    sub_category: 'Dal',
  ...
  {
    meal_type: 'dinner', name: 'Chana Masala', cuisine_type: 'North Indian',
    sub_category: 'Dal',
    description: 'Spiced chickpea curry — wholesome high-protein dinner',
    prep_time_minutes: 10, cook_time_minutes: 30, servings: 4,
    calories_per_serving: 440, protein_g: 17, carbs_g: 70, fat_g: 14, fiber_g: 12,
  ...
  {
    meal_type: 'dinner', name: 'Moong Dal Tadka', cuisine_type: 'Indian',
    sub_category: 'Dal',
    description: 'Light yellow moong dal with a simple ghee-cumin-garlic tadka, served with rice',
    prep_time_minutes: 5, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 345, protein_g: 15, carbs_g: 68, fat_g: 10, fiber_g: 7,
  ...
  {
    meal_type: 'dinner', name: 'Chana Dal', cuisine_type: 'North Indian',
    sub_category: 'Dal',
    description: 'Split chickpea dal with whole spices and a fragrant ghee tadka',
    prep_time_minutes: 10, cook_time_minutes: 30, servings: 4,
    calories_per_serving: 430, protein_g: 18, carbs_g: 64, fat_g: 15, fiber_g: 11,
  ...
  {
    meal_type: 'dinner', name: 'Panchmel Dal', cuisine_type: 'Rajasthani',
    sub_category: 'Dal',
    description: 'Five lentils cooked together with spices — Rajasthani dal dhokli style',
    prep_time_minutes: 10, cook_time_minutes: 30, servings: 4,
    calories_per_serving: 395, protein_g: 18, carbs_g: 72, fat_g: 12, fiber_g: 10,
  ...
  {
    meal_type: 'dinner', name: 'Veg Khichdi', cuisine_type: 'Indian',
    sub_category: 'Khichdi',
    description: 'One-pot rice, moong dal and mixed veg khichdi with ghee — complete comforting meal',
    prep_time_minutes: 10, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 370, protein_g: 13, carbs_g: 58, fat_g: 10, fiber_g: 6,
  ...
  // ─── Rice/Chawal ───
  {
    meal_type: 'dinner', name: 'Coconut Rice', cuisine_type: 'South Indian',
    sub_category: 'Rice/Chawal',
    description: 'Fragrant coconut-tempered rice served with toor dal sambar and papad',
    prep_time_minutes: 10, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 430, protein_g: 10, carbs_g: 70, fat_g: 14, fiber_g: 4,
  ...
  {
    meal_type: 'dinner', name: 'Veg Pulao', cuisine_type: 'Indian',
    sub_category: 'Rice/Chawal',
    description: 'Mildly spiced vegetable pulao served with refreshing boondi raita',
    prep_time_minutes: 10, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 440, protein_g: 11, carbs_g: 70, fat_g: 14, fiber_g: 5,
  ...
  {
    meal_type: 'dinner', name: 'Jeera Rice', cuisine_type: 'Indian',
    sub_category: 'Rice/Chawal',
    description: 'Fragrant cumin-tempered basmati rice — pairs perfectly with any dal or sabzi',
    prep_time_minutes: 5, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 410, protein_g: 13, carbs_g: 72, fat_g: 12, fiber_g: 4,
  ...
  {
    meal_type: 'dinner', name: 'Steamed Basmati Rice', cuisine_type: 'Indian',
    sub_category: 'Rice/Chawal',
    description: 'Perfectly cooked fluffy basmati rice — essential with any dal or sabzi',
    prep_time_minutes: 5, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 200, protein_g: 4, carbs_g: 42, fat_g: 1, fiber_g: 0,
  ...
  {
    meal_type: 'dinner', name: 'Matar Pulao', cuisine_type: 'North Indian',
    sub_category: 'Rice/Chawal',
    description: 'Fragrant basmati rice with green peas and cumin — quick wholesome rice dish',
    prep_time_minutes: 5, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 340, protein_g: 9, carbs_g: 58, fat_g: 8, fiber_g: 4,
  ...
  {
    meal_type: 'dinner', name: 'Kashmiri Pulao', cuisine_type: 'Kashmiri',
    sub_category: 'Rice/Chawal',
    description: 'Saffron rice with dry fruits, nuts and rose petals — a royal festive rice',
    prep_time_minutes: 10, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 420, protein_g: 8, carbs_g: 62, fat_g: 14, fiber_g: 2,
  ...
  {
    meal_type: 'dinner', name: 'Methi Rice', cuisine_type: 'Indian',
    sub_category: 'Rice/Chawal',
    description: 'Rice cooked with fresh fenugreek leaves and mild spices — aromatic and nutritious',
    prep_time_minutes: 5, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 330, protein_g: 7, carbs_g: 54, fat_g: 9, fiber_g: 3,
  ...
  {
    meal_type: 'dinner', name: 'Tamarind Rice', cuisine_type: 'South Indian',
    sub_category: 'Rice/Chawal',
    description: 'Tangy South Indian tamarind rice with peanuts and curry leaf tempering — Puliyodarai',
    prep_time_minutes: 10, cook_time_minutes: 15, servings: 4,
    calories_per_serving: 390, protein_g: 7, carbs_g: 62, fat_g: 13, fiber_g: 3,
  ...
  {
    meal_type: 'dinner', name: 'Ghee Rice', cuisine_type: 'Kerala',
    sub_category: 'Rice/Chawal',
    description: 'Fragrant Kerala-style ghee rice with cashews and fried onion — rich and festive',
    prep_time_minutes: 5, cook_time_minutes: 25, servings: 4,
    calories_per_serving: 370, protein_g: 6, carbs_g: 52, fat_g: 14, fiber_g: 1,
  ...
  {
    meal_type: 'dinner', name: 'Paneer Biryani', cuisine_type: 'Mughal',
    sub_category: 'Biryani',
    description: 'Aromatic basmati rice layered with marinated paneer, saffron and fried onions',
    prep_time_minutes: 25, cook_time_minutes: 40, servings: 4,
    calories_per_serving: 560, protein_g: 18, carbs_g: 72, fat_g: 20, fiber_g: 5,
  ...
  {
    meal_type: 'dinner', name: 'Mushroom Biryani', cuisine_type: 'Hyderabadi',
    sub_category: 'Biryani',
    description: 'Earthy mushrooms dum-cooked with fragrant basmati rice and whole spices',
    prep_time_minutes: 20, cook_time_minutes: 40, servings: 4,
    calories_per_serving: 490, protein_g: 12, carbs_g: 72, fat_g: 15, fiber_g: 5,
  ...
  {
    meal_type: 'dinner', name: 'Matar Biryani', cuisine_type: 'Indian',
    sub_category: 'Biryani',
    description: 'Fragrant basmati rice with green peas, mint and aromatic whole spices',
    prep_time_minutes: 15, cook_time_minutes: 35, servings: 4,
    calories_per_serving: 450, protein_g: 11, carbs_g: 74, fat_g: 12, fiber_g: 6,
  ...
  {
    meal_type: 'dinner', name: 'Kathal Biryani', cuisine_type: 'Awadhi',
    sub_category: 'Biryani',
    description: 'Raw jackfruit slow-cooked with aromatic biryani spices — meaty and indulgent',
    prep_time_minutes: 25, cook_time_minutes: 45, servings: 4,
    calories_per_serving: 480, protein_g: 10, carbs_g: 76, fat_g: 13, fiber_g: 8,
  ...
  {
    meal_type: 'dinner', name: 'Tawa Biryani', cuisine_type: 'Mumbai Street',
    sub_category: 'Biryani',
    description: 'Street-style biryani tossed on a large tawa with vegetables and biryani masala',
    prep_time_minutes: 10, cook_time_minutes: 20, servings: 4,
    calories_per_serving: 440, protein_g: 10, carbs_g: 68, fat_g: 14, fiber_g: 5,
  ...
  // ─── Chana Chole ───
  {
    meal_type: 'dinner', name: 'Chana Masala with Bhatura', cuisine_type: 'Punjabi',
    sub_category: 'Chana Chole',
    description: 'Spiced chickpea curry with fluffy deep-fried bhatura — a festive treat',
    prep_time_minutes: 15, cook_time_minutes: 30, servings: 4,
    calories_per_serving: 620, protein_g: 18, carbs_g: 82, fat_g: 24, fiber_g: 12,
  ...
  // ─── Thali ───
  {
    meal_type: 'dinner', name: 'Mix Veg Thali', cuisine_type: 'Indian',
    sub_category: 'Thali',
    description: 'Complete thali with 2 sabzis, dal, rice, 2 rotis, salad and dahi',
    prep_time_minutes: 20, cook_time_minutes: 40, servings: 4,
    calories_per_serving: 620, protein_g: 22, carbs_g: 92, fat_g: 22, fiber_g: 10,
  ...
  {
    meal_type: 'dinner', name: 'Lemon Rice', cuisine_type: 'South Indian',
    sub_category: 'Rice Dishes',
    description: 'Zesty South Indian rice with lemon juice, peanuts and curry leaf tempering',
    prep_time_minutes: 5, cook_time_minutes: 10, servings: 4,
    calories_per_serving: 400, protein_g: 8, carbs_g: 62, fat_g: 13, fiber_g: 2,
